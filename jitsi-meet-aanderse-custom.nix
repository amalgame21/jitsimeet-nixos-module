  ...
  config = mkIf cfg.enable {
    services.prosody = mkIf cfg.prosody.enable {
      ...
      settings = {
        ...
        "bosh"
        # "pubsub" This makes the "Invite to Conversations" menu not showing up in conversation (mod_invites). Must not enable globally
        "ping"
        "roster"
        "saslauth"
        "smacks"
      ...
      virtualHosts.${cfg.hostName} = {
        settings = {
          ...
          # c2s_require_encryption = true; # for testing
      ...
      virtualHosts."recorder.${cfg.hostName}" = {
        settings = {
          ...
          authentication = "internal_hashed"; # For testing
          c2s_require_encryption = false;
          # c2s_require_encryption = true; # For testing
        };
      };
