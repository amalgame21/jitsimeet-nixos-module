...
in
{
  ...
  options.services.prosody = {
    ...
    environmentFiles = mkOption {
      ...
      default = [];
      description = mdDoc ''
        Files which may contain secrets in the format of an EnvironmentFile as described
        ...
        ::: {.note}
        Environment variables in these files should *not* begin with an `ENV_` prefix, only
      ...
      serviceConfig = mkMerge [
        {
          ...
          EnvironmentFile = mkIf (cfg.environmentFiles != null) cfg.environmentFiles;
